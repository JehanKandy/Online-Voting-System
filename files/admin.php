...
<nav class="navbar navbar-dark bg-dark">
    <a class="navbar-brand"  style="font-family:'Bebas Neue', cursive; font-size:150%" href="#">Online Voting System 2023 - Admin Panel</a>
...
<div class="container">
    ...
    <hr>
    <br><br>
        <center><h1>Admin Operations</h1>
        <br><br>
        <table border="0">
            <tr>
                <td>
                    <a href="all_event.php"><button class="btn btn-primary">Events Management</button></a>
                </td>
                <td>
                    <a href="all_user.php"><button class="btn btn-success">User Management</button></a>
                </td>
                <td>
                    <a href="all_party.php"><button class="btn btn-info">Political Party Management</button></a>
                </td>
            </tr>
        </table>
        <?php
            $user_count = "SELECT * FROM user_tbl";
            $user_count_result = mysqli_query($con, $user_count);
            $user_nor = mysqli_num_rows($user_count_result);

            $event_count = "SELECT * FROM events";
            $event_count_result = mysqli_query($con, $event_count);
            $event_nor = mysqli_num_rows($event_count_result);

            $party_count = "SELECT * FROM p_party";
            $party_count_result = mysqli_query($con, $party_count);
            $party_nor = mysqli_num_rows($party_count_result);
        ?>
        <br><br><br>
        <table border="0">
            <tr>
                <td>
                    <p style="font-size: 150%;"><b>Events</b></p>
                </td>
                <td>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                </td>
                <td>
                    <p style="font-size: 150%;"><b>Users</b></p>
                </td>
                <td>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                </td>
                <td>
                    <p style="font-size: 150%;"><b>Political Parties</b></p>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <p style="font-size: 200%;"><?php echo $event_nor; ?></p>
                </td>
                <td>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                </td>
                <td align="center">
                    <p style="font-size: 200%;"><?php echo $user_nor; ?></p>
                </td>
                <td>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                </td>
                <td align="center">
                    <p style="font-size: 200%;"><?php echo $party_nor; ?></p>
                </td>
            </tr>
        </table>
        </center>
